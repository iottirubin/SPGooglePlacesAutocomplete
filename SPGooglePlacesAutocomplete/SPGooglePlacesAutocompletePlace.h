...
@property (nonatomic, strong) NSString *neighborhood; // sublocality_level_1

@property (nonatomic, strong) NSString *provincy; // administrative_area_level_1

@property (nonatomic, strong) NSString *city; // administrative_area_level_2
